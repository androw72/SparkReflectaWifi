...
namespace reflectaHeartbeat
{
  ...
  bool (*heartbeatFunctions[MaxFunctions])(Adafruit_CC3000_ClientRef& client);
  ...
  void setFrameRate(Adafruit_CC3000_ClientRef& client) {
  ...
  void sendHeartbeat(Adafruit_CC3000_ClientRef& client) {
