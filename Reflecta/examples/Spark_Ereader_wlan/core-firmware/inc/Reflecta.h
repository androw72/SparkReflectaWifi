...
namespace reflectaFrames
{
  ...
  typedef void (*frameReceivedFunction)(byte sequence, byte frameLength, byte* frame, TCPClient & client);
  ...
  void sendEvent(reflecta::FunctionId type, byte code, TCPClient& client);
...
namespace reflectaFunctions
{
  ...
  void push16(int16_t b, TCPClient& client);
